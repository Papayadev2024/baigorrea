                ...
                <div class="grid grid-cols-2 lg:grid-cols-5 gap-5 lg:gap-0">
                    <div class="col-span-2 flex flex-col justify-between pb-0 lg:pb-10">
                        <div class="flex flex-col p-2 justify-center items-start gap-8">
                            <h2 class="text-[#09262A] font-merchant_medium text-5xl xl:text-6xl 2xl:text-7xl leading-[60px] tracking-tighter" data-aos="fade-down">Acompañamos el bienestar emocional y conductual de tu hijo</h2>
