    ...
    <div class="grid grid-cols-1 w-full px-[5%] lg:px-[8%] py-10 lg:py-16 gap-10 md:gap-5">
        <div class="w-full flex flex-row justify-center items-center gap-10 lg:gap-5 col-span-1">
            <div class="flex flex-col gap-3 text-center">
                ...
                <div class="font-Montserrat_Medium text-[#B380B5] py-3 px-2 bg-[#E4EFF0] justify-center items-center rounded-3xl inline-flex text-base xl:text-lg 2xl:text-xl w-full max-w-xs 2xl:max-w-sm mx-auto mt-6">
